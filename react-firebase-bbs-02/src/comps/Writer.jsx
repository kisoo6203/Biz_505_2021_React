 ...
 * 
 * reat use로 시작되는 함수들을 Hook 함수라고 한다
...
function Writer() {
	...
	// /write/:id 로 설정된 Route에서 id위치에 담긴 변수 값
	// 가져오기
	...
	const onClickSave = () =>{
		 ...
		 * doc().set()을 병행하여 사용하면 Update Or Insert
		 */
	...
	return (
		<div className="input_box">
			<div>
				...
				*/}
				<input name="b_writer" onChange={onChange} placeholder="작성자" defaultValue={bbs.b_writer}></input>
			</div>
			<div>
				<input name="b_subject" onChange={onChange} placeholder="제목" defaultValue={bbs.b_subject}></input>
			</div>
			<div>
				<input name="b_content" onChange={onChange} placeholder="내용" defaultValue={bbs.b_content}></input>
			</div>
