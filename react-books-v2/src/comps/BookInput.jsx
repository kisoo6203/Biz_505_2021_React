...
function BookInput() {
	...
	return (
		<div>
			<input name="b_name" onChange={onChangeHandler} placeholder="도서명 입력" value={book.b_name}/>
			<input name="b_genre" onChange={onChangeHandler} placeholder="장르 입력" value={book.b_genre}/>
